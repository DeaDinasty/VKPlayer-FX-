 ...
 */
package sample.org.jaudiotagger.tag.datatype;

import sample.org.jaudiotagger.tag.InvalidDataTypeException;
import sample.org.jaudiotagger.tag.id3.AbstractTagFrameBody;
import sample.org.jaudiotagger.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link sample.org.jaudiotagger.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link sample.org.jaudiotagger.tag.id3.framebody.FrameBodySYTC}
 *
