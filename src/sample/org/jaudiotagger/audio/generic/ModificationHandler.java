...
import sample.org.jaudiotagger.audio.exceptions.ModifyVetoException;
...
public class ModificationHandler implements AudioFileModificationListener
{
     ...
     * (overridden)
     *
     * @see sample.org.jaudiotagger.audio.generic.AudioFileModificationListener#fileModified(org.jaudiotagger.audio.AudioFile,
     *File)
     */
     ...
     * (overridden)
     *
     * @see sample.org.jaudiotagger.audio.generic.AudioFileModificationListener#fileOperationFinished(File)
     */
     ...
     * (overridden)
     *
     * @see sample.org.jaudiotagger.audio.generic.AudioFileModificationListener#fileWillBeModified(org.jaudiotagger.audio.AudioFile,
     *boolean)
     */
     ...
     * (overridden)
     *
     * @see sample.org.jaudiotagger.audio.generic.AudioFileModificationListener#vetoThrown(org.jaudiotagger.audio.generic.AudioFileModificationListener,
     *sample.org.jaudiotagger.audio.AudioFile,
     *sample.org.jaudiotagger.audio.exceptions.ModifyVetoException)
     */
