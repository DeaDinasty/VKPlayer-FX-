...
import static sample.org.jaudiotagger.audio.aiff.AiffType.AIFC;
import static sample.org.jaudiotagger.audio.aiff.AiffType.AIFF;
import static sample.org.jaudiotagger.audio.iff.IffHeaderChunk.HEADER_LENGTH;
import static sample.org.jaudiotagger.audio.iff.IffHeaderChunk.TYPE_LENGTH;
...
public class AiffFileHeader
{
    ...
    private static Logger logger = Logger.getLogger("sample.org.jaudiotagger.audio.aiff.AudioFileHeader");

    /**
     * Reads the file header and registers the data (file type) with the given header.
     *
     * @param fc random access file
     * @param aiffAudioHeader the {@link sample.org.jaudiotagger.audio.AudioHeader} we set the read data to
     * @param fileName
