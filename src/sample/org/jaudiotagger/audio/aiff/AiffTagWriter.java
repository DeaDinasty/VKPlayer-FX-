...
import sample.org.jaudiotagger.audio.aiff.chunk.AiffChunkSummary;
import sample.org.jaudiotagger.audio.aiff.chunk.AiffChunkType;
...
import sample.org.jaudiotagger.audio.iff.Chunk;
import sample.org.jaudiotagger.audio.iff.ChunkHeader;
import sample.org.jaudiotagger.audio.iff.ChunkSummary;
...
import static sample.org.jaudiotagger.audio.iff.IffHeaderChunk.SIGNATURE_LENGTH;
import static sample.org.jaudiotagger.audio.iff.IffHeaderChunk.SIZE_LENGTH;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("sample.org.jaudiotagger.audio.aiff");
    ...
    /**
     * Writes data as a {@link sample.org.jaudiotagger.audio.aiff.chunk.AiffChunkType#TAG} chunk to the file.
     *
     * @param fc filechannel
