...
import static sample.org.jaudiotagger.audio.dsf.DsdChunk.CHUNKSIZE_LENGTH;
...
{
    public static Logger logger = Logger.getLogger("sample.org.jaudiotagger.audio.dsf.FmtChunk");
     ...
     *                       fields
     * @return an empty {@link sample.org.jaudiotagger.audio.generic.GenericAudioHeader} if audioInfoChunk has less
