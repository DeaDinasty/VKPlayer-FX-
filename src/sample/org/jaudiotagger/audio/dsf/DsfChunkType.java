...
/**
 * Chunk types mark each {@link sample.org.jaudiotagger.audio.iff.ChunkHeader}. They are <em>always</em> 4 ASCII chars long.
 *
 * @see sample.org.jaudiotagger.audio.iff.Chunk
 */
public enum DsfChunkType
{
    ...
    /**
     * Get {@link sample.org.jaudiotagger.audio.dsf.DsfChunkType} for code (e.g. "SSND").
     *
     * @param code chunk id
