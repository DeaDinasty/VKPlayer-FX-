 ...
 */
package sample.org.jaudiotagger.audio.asf;

import sample.org.jaudiotagger.audio.AudioFile;
import sample.org.jaudiotagger.audio.asf.data.AsfHeader;
import sample.org.jaudiotagger.audio.asf.data.AudioStreamChunk;
import sample.org.jaudiotagger.audio.asf.data.MetadataContainer;
import sample.org.jaudiotagger.audio.asf.data.MetadataDescriptor;
import sample.org.jaudiotagger.audio.asf.io.*;
import sample.org.jaudiotagger.audio.asf.util.TagConverter;
import sample.org.jaudiotagger.audio.asf.util.Utils;
...
import sample.org.jaudiotagger.tag.asf.AsfTag;
...
public class AsfFileReader extends AudioFileReader
{
     ...
     * Logger instance
     */
    private final static Logger LOGGER = Logger.getLogger("sample.org.jaudiotagger.audio.asf");
     ...
     * (overridden)
     *
     * @see sample.org.jaudiotagger.audio.generic.AudioFileReader#getEncodingInfo(java.io.RandomAccessFile)
     */
    @Override
     ...
     * (overridden)
     *
     * @see sample.org.jaudiotagger.audio.generic.AudioFileReader#getTag(java.io.RandomAccessFile)
     */
    @Override
